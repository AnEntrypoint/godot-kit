...
const GDLINTRC_CONTENT = `max-line-length: 100
`;

const SKILL_CONTENT = `---
name: godot-dev
description: Godot 4.x agentic development CLI - editor control, game runtime, REPL, debugger
triggers: [godot, gd, gdscript, ".gd", scene tree, game debug, repl_bridge, godot-dev]
...
\`\`\`bash
godot-dev editor create /root/Main Sprite2D player_sprite
\`\`\`
...
function installGlobalSkills() {
  ...
  tryWrite(path.join(home, '.claude', 'skills', 'godot-dev.md'), SKILL_CONTENT, 'Claude Code skill (global)');
